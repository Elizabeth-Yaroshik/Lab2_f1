...
((SELECT pilot_id FROM Pilots WHERE full_name = 'Макс Ферстаппен'), 'Гран-при Японии', '2025-03-29', 8, 5316.08),
((SELECT pilot_id FROM Pilots WHERE full_name = 'Ландо Норрис'), 'Гран-при Японии', '2025-03-29', 5, 5306.882);
